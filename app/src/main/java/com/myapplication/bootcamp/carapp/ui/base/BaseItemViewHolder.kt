package com.myapplication.bootcamp.carapp.ui.base
...
import com.myapplication.bootcamp.carapp.di.component.DaggerViewHolderComponent
...
import com.myapplication.bootcamp.carapp.utils.display.Toaster
...
abstract class BaseItemViewHolder<T : Any, VM : BaseItemViewModel<T>>(
    ...
    private fun buildViewHolderComponent() =
        DaggerViewHolderComponent
            .builder()
            .applicationComponent((itemView.context.applicationContext as CarApplication).applicationComponent)
